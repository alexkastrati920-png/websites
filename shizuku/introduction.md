...
3. (pre-Pie) Start the Java process with app_process ([see here](https://android.googlesource.com/platform/platforme/+/oreo-release/cmds/pm/pm))
4. (Pie+) Execute the native program `cmd` ([see hecmd(https://android.googlesource.com/platform/frameworks/native/+/pie-release/cmds/cmd/))
